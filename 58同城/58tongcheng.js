...
get_password = function(password) {
    ...
    return '010001' && (r.rsaExponent = '010001'),
...
&& (r.rsaModulus = ""),
        encryptString(o + encodeURIComponent(password), '010001', "")
};

//console.log(get_password('999999999'));
get_jc = function () {
    jc = "JsonpCallBack" + (new Date).getTime() + Math.floor(1e3 * Math.random());
    return jc
};
//console.log(get_jc());
...
// fingetprint == finger_session
// var fingerPrint = {
//     validArray: function(t) {
//         return 2 == t.length
//     },
//     formatStr: function(t) {
//         return void 0 === t ? "" : t
//     },
//     targetFingerprint: function(t, r) {
//         return this.validArray(t) ? !this.validArray(r) || parseInt(t[1]) > parseInt(r[1]) ? t : r : this.validArray(r) ? r : []
//     },
//     set: function(t) {
//         var r = t.data.fingerprint
//             , e = (new Date).getTime();
//         ppStore.set("fingerprint", r + "＿" + e)
//     },
//     get: function() {
//         var t = "fingerprint"
//             , r = ppStore.get(t)
...
//             n = this.formatStr(n),
//             i = this.formatStr(i);
//         var a, o, g, p = e.split("＿"), l = n.split("＿"), s = i.split("＿");
//         a = this.validArray(p) ? "1" : "0",
//             o = this.validArray(l) ? "1" : "0",
//             g = this.validArray(s) ? "1" : "0";
//         var f = this.targetFingerprint(this.targetFingerprint(p, l), s);
//         if (0 == f.length && (f[0] = ""),
//             this.validArray(f)) {
//             ppStore.clear(t);
//             var d = (new Date).getTime();
//             ppStore.set(t, f[0] + "＿" + d)
//         }
//         var u = a + o + g;
//         return "undefined" == f[0] && (f[0] = "",
//             ppStore.clear(t)),
//         document.getElementById("fingerprint") && (document.getElementById("fingerprint").value = f[0] + "_" + u),
//         f[0] + "_" + u
//     },
//     getnew: function() {
//         var t = document.cookie.match(new RegExp("finger_session=([^&;]+)"));
//         try {
//             return document.getElementById("fingerprint") && (document.getElementById("fingerprint").value = t[1]),
//                 t[1]
//         } catch (t) {
//             return "111_000"
//         }
